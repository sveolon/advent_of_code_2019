fn int_comp(arr: [i32;34], input1: i32, input2: i32) -> i32 {
    let mut a = arr;
    let mut i = 0;
...
fn heap_permutation(mut a: [usize; 5], size: usize, output: &mut Vec<[usize;5]>) 
{ 
...
fn main() {
    ...
    let setting1 = [0,1,2,3,4];
    let mut all_permutations = Vec::new();
    heap_permutation(setting1, 5, &mut all_permutations);
    let mut result = 0;
