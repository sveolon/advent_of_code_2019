...
fn int_comp(arr: Vec<i64>, input1: i64) -> i64 {
    ...
    visited.insert((0,0));
    let mut curr = (0, (0, 0), 0); //(direction, (x,y), num_steps)
    //north (1), south (2), west (3), and east (4)
    queue.push_front((1, (0,1), 1));
    queue.push_front((2, (0,-1), 1));
    ...
    loop {
        ...
        if op == 4 {
            ...
            if output == 2 {
                ...
                let x = (curr.1).0;
                let y = (curr.1).1;
                let num_steps = curr.2 + 1;
                if !visited.contains(&(x, y+1)) {
                    queue.push_back((1, (x, y+1), num_steps));
                }
                if !visited.contains(&(x, y-1)) {
                    queue.push_back((2, (x, y-1), num_steps));
                }
                if !visited.contains(&(x-1, y)) {
                    queue.push_back((3, (x-1, y), num_steps));
                }
                if !visited.contains(&(x+1, y)) {
                    queue.push_back((4, (x+1, y), num_steps));
                }
            }
