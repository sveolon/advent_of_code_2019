...
fn int_comp(arr: Vec<i64>, input1: i64, input2: i64) -> i64 {
    let mut a = arr;
    let mut i = 0;
    ...
    loop {
        ...
        if a[i] % 1000 / 100 == 0 {
            a1 = a[a1 as usize];
        } else if a[i] % 1000 / 100 == 2 {
            //print!("rb{}+a1{} = {},",rb, a1, rb + a1 as i64);
            a1 = a[(rb + a1 as i64) as usize];
        };
